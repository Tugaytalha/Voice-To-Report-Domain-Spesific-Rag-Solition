...
\title{InsightBridge: A Voice-to-Report System for Automated Radiology Reporting using Retrieval-Augmented Generation}
\author{Tugay Talha İçen}
\faculty{Faculty of Engineering}
\department{Computer Engineering Department}
\supervisor{Assoc. Prof. Dr. Habil KALKAN}
\theyear{2025}
...
\makejury{26/03/2025}{Assist. Prof. Tülay AYYILDIZ}
...
\input{./Body/Backmatter/References}
\addtocontents{toc}{\protect\vspace{18pt}}
